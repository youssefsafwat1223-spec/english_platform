...
class EnglishCurriculumSeeder extends Seeder
{
    public function run(): void
    {
        DB::transaction(function () {
            ...
            // Curriculum definition: level_title => [lesson titles]
            $curriculum = [
            ...
            foreach ($curriculum as $levelTitle => $lessons) {
                ...
                foreach ($lessons as $lessonTitle) {
                    // Generate unique slug by appending the lesson order number
    ...
    public function run(): void
    {
        ...
        $this->command->info("✅ Course '{$course->title}' created with ID: {$courseId}");
        $this->command->info("   Levels: " . ($levelOrder - 1));
        $this->command->info("   Lessons: " . ($globalLessonOrder - 1));
    }
}
