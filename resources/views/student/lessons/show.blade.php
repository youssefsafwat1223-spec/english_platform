                            ...
                            <div class="aspect-video bg-black rounded-[1.5rem] overflow-hidden shadow-2xl relative" id="vdo-player-container">
                                ...
                                <div id="vdo-loading" class="absolute inset-0 flex items-center justify-center bg-black z-10">
                                    <div class="flex flex-col items-center gap-3">
                                        ...
                                        <span class="text-white font-bold text-sm tracking-wider">{{ __('Ã«—Ì  Õ„Ì· «·›ÌœÌÊ...') }}</span>
                                    </div>
                                </div>
                                <iframe
                                    id="vdo-iframe"
                                ...
                                @else
                                    ...
                                    <div id="videoLoaderOverlay" class="absolute inset-0 flex items-center justify-center bg-black/80 z-20">
                                        <div class="flex flex-col items-center gap-3">
                                            ...
                                            <span class="text-white font-bold text-sm tracking-wider">{{ __('Ã«—Ì  ÃÂÌ“ «·›ÌœÌÊ...') }}</span>
                                        </div>
                                    </div>
                                @endif
                            </div>
                    ...
                    <div class="glass-card overflow-hidden rounded-[1.5rem] border border-primary-500/20 shadow-lg shadow-primary-500/5 group" x-data="createAudioPlayer('{{ Storage::url($lesson->audio->audio_path) }}')" data-aos="fade-up">
                        ...
                        <div class="p-6 md:p-8 relative z-10 flex flex-col md:flex-row items-center gap-6">
                            ...
                            <div class="flex items-center gap-4 shrink-0">
                                ...
                                <div class="md:hidden text-lg font-bold text-slate-900 dark:text-white">{{ __('„·Œ’ ’Ê Ì') }}</div>
                            </div>
                    ...
                    @if($lesson->attachments->count() > 0)
                        <div class="glass-card overflow-hidden rounded-[1.5rem]" data-aos="fade-up">
                            <div class="px-6 py-5 border-b border-slate-200/50 dark:border-white/5 flex items-center gap-3">
                                ...
                                <h3 class="font-bold text-lg text-slate-900 dark:text-white">{{ __('«·„—›ﬁ« ') }}</h3>
                            </div>
                        ...
                        @if($lesson->pronunciationExercise)
                            <div class="glass-card overflow-hidden rounded-[1.5rem] relative group" data-aos="fade-up">
                                ...
                                <div class="px-6 py-5 border-b border-slate-200/50 dark:border-white/5 flex items-center gap-3 relative z-10">
                                    ...
                                    <h3 class="font-bold text-lg text-slate-900 dark:text-white">{{ __(' „—Ì‰ «·‰ÿﬁ') }}</h3>
                                </div>
                                <div class="p-6 relative z-10">
                                    <p class="text-sm mb-5 text-slate-600 dark:text-slate-400 font-medium">{{ __('Õ”¯‰ „Â«—« ﬂ ›Ì «·‰ÿﬁ „⁄  ﬁÌÌ„ ›Ê—Ì »«·–ﬂ«¡ «·«’ÿ‰«⁄Ì.') }}</p>
                        ...
                        @if($completionQuiz)
                            <div class="glass-card overflow-hidden rounded-[1.5rem] relative group" data-aos="fade-up">
                                ...
                                <div class="px-6 py-5 border-b border-slate-200/50 dark:border-white/5 flex items-center gap-3 relative z-10">
                                    ...
                                    <h3 class="font-bold text-lg text-slate-900 dark:text-white">{{ __('«Œ »«—') }}</h3>
                                </div>
                                <div class="p-6 relative z-10">
                                    <p class="text-sm mb-5 text-slate-600 dark:text-slate-400 font-medium">{{ __('«Ã “ «·«Œ »«— √Ê·« Õ Ï Ì „ «Õ ”«» «·œ—” ﬂ„ﬂ „·.') }}</p>
                                    @if($hasPassedCompletionQuiz)
                                        <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                                            ...
                                            <a href="{{ route('student.quizzes.start', $completionQuiz) }}" class="btn-ghost font-bold text-slate-600 dark:text-slate-300 w-full sm:w-auto text-center hover:text-amber-500">{{ __('≈⁄«œ… «·«Œ »«—') }}</a>
                                        </div>
                                    @else
                ...
                <div class="glass-card overflow-hidden rounded-[2rem] border-t-4 border-t-primary-500" id="comments" data-aos="fade-up">
                    <div class="px-8 py-6 border-b border-slate-200/50 dark:border-white/5 bg-slate-50/50 dark:bg-slate-900/20 flex flex-col sm:flex-row items-center justify-between gap-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="font-extrabold text-xl text-slate-900 dark:text-white">{{ __('«·„‰«ﬁ‘…') }}</h3>
                                <p class="text-xs font-medium text-slate-500 tracking-wide uppercase">{{ $lesson->comments()->count() }} {{ __(' ⁄·Ìﬁ') }}</p>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="relative group">
                                        ...
                                        <div class="absolute bottom-3 right-3 flex items-center gap-2 opacity-0 group-focus-within:opacity-100 transition-opacity">
                                            ...
                                            <button type="submit" class="btn-primary ripple-btn h-8 px-4 py-0 rounded-lg shadow-md flex items-center gap-1.5" :disabled="loading || text.length === 0">
                                                <span x-show="!loading" class="font-bold text-xs">{{ __('‰‘—') }}</span>
                                                <span x-show="loading" x-cloak class="font-bold text-xs">{{ __('Ã«—Ì «·‰‘—...') }}</span>
                        ...
                        <div class="space-y-8">
                                                            ...
                                                            <div class="flex-1">
                                                                <div class="bg-slate-50 dark:bg-white/5 border border-slate-200/50 dark:border-white/5 rounded-2xl rounded-tl-none p-3 sm:p-4">
                                                                    <div class="flex items-center gap-2 mb-1">
                                                                        ...
                                                                        @if($reply->is_admin_reply)
                                                                            <span class="inline-flex items-center px-1.5 py-0.5 rounded-md bg-primary-500/10 text-primary-600 dark:text-primary-400 text-[9px] font-black uppercase tracking-wider border border-primary-500/20">{{ __('«·„Õ«÷—') }}</span>
                                                                        @endif
                            ...
                            @empty
                                <div class="text-center py-12 px-4 rounded-2xl border border-dashed border-slate-300 dark:border-slate-700/50 bg-slate-50 dark:bg-slate-800/20">
                                    ...
                                    <p class="text-slate-900 dark:text-white font-bold mb-1">{{ __('·« ÌÊÃœ  ⁄·Ìﬁ« ') }}</p>
                                    <p class="text-sm text-slate-500 dark:text-slate-400">{{ __('ﬂ‰ √Ê· „‰ Ì”√· ”ƒ«· √Ê Ì‘«—ﬂ —√ÌÂ!') }}</p>
                                </div>
                            @endforelse
                        </div>
                    </div>
                    ...
                    <div class="w-full sm:w-auto flex-1 flex justify-start">
                        @if($previousLesson)
                            <a href="{{ route('student.lessons.show', [$course, $previousLesson]) }}" class="btn-ghost flex items-center justify-center gap-2 px-6 py-3 font-bold text-slate-600 dark:text-slate-300 hover:text-primary-500 hover:bg-white dark:hover:bg-slate-800 rounded-xl transition-colors w-full sm:w-auto shadow-sm border border-slate-200 dark:border-white/5">
                                ...
                                <div>
                                    <div class="text-[10px] uppercase tracking-wider text-slate-400 font-bold mb-0.5">{{ __('«·”«»ﬁ') }}</div>
                        ...
                        @if(!$progress->is_completed)
                            @if($requiresQuizPass && !$hasPassedCompletionQuiz)
                                ...
                                <div class="flex flex-col items-stretch gap-2 w-full sm:w-auto">
                                    ...
                                    <p class="text-center text-xs font-bold text-amber-600 dark:text-amber-400">{{ __('·‰ Ì „ «⁄ »«— «·œ—” „ﬂ „·« ﬁ»· ‰Ã«Õﬂ ›Ì «·«Œ »«—.') }}</p>
                                </div>
                            @else
                        ...
                        @if($nextLesson)
                            <a href="{{ route('student.lessons.show', [$course, $nextLesson]) }}" class="btn-primary ripple-btn flex items-center justify-center gap-2 px-6 py-3 font-bold rounded-xl w-full sm:w-auto shadow-md">
                                <div class="text-right">
                                    <div class="text-[10px] uppercase tracking-wider text-white/70 font-bold mb-0.5">{{ __('«· «·Ì') }}</div>
                ...
                <div class="glass-card sticky top-28 overflow-hidden rounded-[2rem] border-t-4 border-t-accent-500 flex flex-col h-[calc(100vh-8rem)]" x-data="notesManager({ id: @js($currentNote?->id), text: @js($currentNote?->note_text ?? '') })" data-aos="fade-left">
                    <div class="px-6 py-5 border-b border-slate-200/50 dark:border-white/5 bg-slate-50/50 dark:bg-slate-900/20 flex items-center justify-between shrink-0">
                        <div class="flex items-center gap-2">
                            ...
                            <h3 class="font-bold text-slate-900 dark:text-white">{{ __('„·«ÕŸ« Ì') }}</h3>
                        </div>
                    ...
                    <div class="p-6 flex-1 flex flex-col min-h-0">
                        ...
                        @if($noteHistory->count() > 0)
                            <div class="shrink-0 pt-4 border-t border-slate-200 dark:border-white/10 max-h-[40%] overflow-y-auto pr-2 custom-scrollbar">
                                <h4 class="font-bold text-xs uppercase tracking-wider text-slate-500 mb-3">{{ __('„·«ÕŸ«  ”«»ﬁ…') }}</h4>
                                <div class="space-y-3">
...
<script>
const lessonUiText = {
    confirmComplete: @json(__(' ﬁœ„ „„ «“! Â·  —Ìœ ≈‰Â«¡ «·œ—” Ê«·«‰ ﬁ«· ··ŒÿÊ… «· «·Ì…ø')),
    completing: @json(__('Ã«—Ì «·≈‰Â«¡...')),
    completed: @json(__(' „!')),
    completedSuccess: @json(__(' „ ≈‰Â«¡ «·œ—” »‰Ã«Õ!')),
    completeError: @json(__('Õ’· Œÿ√! Õ«Ê·  «‰Ì.')),
    notesSaveError: @json(__('›‘· Õ›Ÿ «·„·«ÕŸ« .  √ﬂœ „‰ «·« ’«·.')),
