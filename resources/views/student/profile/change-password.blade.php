...
<div class="py-12 relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="relative glass-card overflow-hidden rounded-[2rem] p-8 mb-8" data-aos="fade-down">
            <div class="absolute inset-0 bg-gradient-to-br from-red-500/10 via-transparent to-primary-500/10 opacity-50"></div>
            ...
            <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    ...
                    <h1 class="text-3xl md:text-5xl font-extrabold mb-2 text-slate-900 dark:text-white tracking-tight">
                        {{ __('Change') }} <span class="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-primary-500">{{ __('Password') }}</span>
                    </h1>
        ...
        <form action="{{ route('student.profile.update-password') }}" method="POST" x-data="{ loading: false }" @submit="loading = true" data-aos="fade-up">
            ...
            <div class="glass-card overflow-hidden">
                <div class="glass-card-body space-y-6">
                    <div>
                        <label class="block text-sm font-semibold mb-2" style="color: var(--color-text);">Current Password *</label>
                        <div class="relative" x-data="{ show: false }">
                            ...
                            <input :type="show ? 'text' : 'password'" name="current_password" class="input-glass pl-12 pr-12" required>
                            <button type="button" @click="show = !show" class="absolute inset-y-0 right-0 pr-4 flex items-center" style="color: var(--color-text-muted);">
                    ...
                    <div>
                        <label class="block text-sm font-semibold mb-2" style="color: var(--color-text);">New Password *</label>
                        <div class="relative" x-data="{ show: false }">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            ...
                            <input :type="show ? 'text' : 'password'" name="password" class="input-glass pl-12 pr-12" required>
                            <button type="button" @click="show = !show" class="absolute inset-y-0 right-0 pr-4 flex items-center" style="color: var(--color-text-muted);">
                                <svg x-show="!show" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                <svg x-show="show" x-cloak class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"/></svg>
                            </button>
                    ...
                    <div>
                        <label class="block text-sm font-semibold mb-2" style="color: var(--color-text);">Confirm New Password *</label>
                        <div class="relative" x-data="{ show: false }">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            ...
                            <input :type="show ? 'text' : 'password'" name="password_confirmation" class="input-glass pl-12 pr-12" required>
                            <button type="button" @click="show = !show" class="absolute inset-y-0 right-0 pr-4 flex items-center" style="color: var(--color-text-muted);">
                                <svg x-show="!show" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                <svg x-show="show" x-cloak class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"/></svg>
                            </button>
                ...
                <div class="glass-card-footer flex justify-between items-center">
                    <a href="{{ route('student.profile.show') }}" class="btn-secondary">Cancel</a>
