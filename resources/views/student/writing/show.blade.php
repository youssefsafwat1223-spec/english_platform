...
<div class="py-12 relative min-h-screen z-10">
    <div class="student-container space-y-8">
        ...
        @php
            ...
            if ($contextCourse && $writingExercise->lesson) {
                $courseReturnUrl = route('student.courses.learn', $contextCourse) . '#lesson-' . $writingExercise->lesson->id;
            } elseif ($contextCourse && $writingExercise->courseLevel) {
                $courseReturnUrl = route('student.courses.learn', $contextCourse) . '#level-' . $writingExercise->courseLevel->id;
            }
        @endphp
