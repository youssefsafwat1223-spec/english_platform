                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-center justify-between text-xs font-medium mb-6" style="color: var(--color-text-muted);">
                            <div class="flex items-center gap-1">
                                ...
                                {{ $course->estimated_duration_weeks ? ($isArabic ? 'مدة مقترحة: ' . $course->estimated_duration_weeks . ' أسبوعًا' : 'Recommended duration: ' . $course->estimated_duration_weeks . ' weeks') : ($isArabic ? 'تعلّم بالوتيرة المناسبة لك' : 'Self-paced') }}
                            </div>
                        </div>
