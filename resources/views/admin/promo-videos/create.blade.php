...
@section('title', __('إضافة فيديو شرح'))
@section('content')
<div class="py-12 relative overflow-hidden">
    ...
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 relative z-10">
        <div class="mb-8" data-aos="fade-down">
            ...
            <h1 class="text-3xl font-extrabold mt-4"><span class="text-gradient">{{ __('إضافة فيديو شرح') }}</span></h1>
        </div>

        <div class="glass-card p-8" data-aos="fade-up">
            <form action="{{ route('admin.promo-videos.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" name="title" value="{{ old('title') }}" required
                        ...
                        placeholder="{{ __('مثل: مقدمة في القواعد الأساسية') }}">
                ...
                <div>
                    ...
                    <textarea name="description" rows="3"
                        class="w-full bg-slate-50 dark:bg-black/20 border border-slate-200 dark:border-white/10 rounded-xl py-3 px-4 font-semibold focus:border-primary-500 focus:ring-1 focus:ring-primary-500 transition-colors" style="color: var(--color-text);"
                        placeholder="{{ __('وصف قصير عن محتوى الفيديو...') }}">{{ old('description') }}</textarea>
                ...
                <div>
                    ...
                    <p class="text-xs mt-1" style="color: var(--color-text-muted);">{{ __('لو مش هترفع صورة، هنستخدم صورة افتراضية') }}</p>
