                    ...
                    @forelse($campaigns as $campaign)
                        <tr class="hover:bg-white/5 transition-colors duration-200 group">
                            ...
                            <td class="px-6 py-4">
                                @php
                                    $audienceLabels = [
                                        'all' => [__('All Students'), 'bg-blue-500/20 text-blue-400 border-blue-500/30'],
                                        'active' => [__('Active'), 'bg-green-500/20 text-green-400 border-green-500/30'],
                                        'inactive' => [__('Inactive'), 'bg-yellow-500/20 text-yellow-400 border-yellow-500/30'],
                                        'course_specific' => [$campaign->targetCourse->title ?? __('Course'), 'bg-purple-500/20 text-purple-400 border-purple-500/30'],
                                    ];
                                    $label = $audienceLabels[$campaign->target_audience] ?? [__('Unknown'), 'bg-gray-500/20 text-gray-400 border-gray-500/30'];
                                @endphp
                            ...
                            <td class="px-6 py-4">
                                ...
                                @endphp
                                <span class="px-3 py-1 rounded-full text-xs font-bold {{ $statusStyles[$campaign->status] ?? 'bg-gray-700 text-gray-300' }}">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center py-16">
                                <div class="text-6xl mb-4 opacity-50"><i class="fas fa-inbox"></i></div>
