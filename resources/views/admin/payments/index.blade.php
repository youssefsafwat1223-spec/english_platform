...
<div class="py-12 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            @php $payStats = [
                ['v' => number_format($stats['total_revenue'], 2).' '.__('ر.س'), 'l' => 'Total Revenue', 'c' => 'text-emerald-500'],
                ['v' => number_format($stats['revenue_today'], 2).' '.__('ر.س'), 'l' => 'Today', 'c' => 'text-primary-500'],
                ['v' => number_format($stats['revenue_this_month'], 2).' '.__('ر.س'), 'l' => 'This Month', 'c' => 'text-blue-500'],
