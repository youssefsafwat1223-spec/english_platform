        ...
        @if($hasFilters ?? false)
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                <div class="glass-card p-6" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="text-3xl font-black text-emerald-400">${{ number_format($stats['total_revenue'], 2) }}</div>
                </div>
                ...
                <div class="glass-card p-6" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="text-3xl font-black text-purple-400">${{ number_format($stats['average_value'], 2) }}</div>
                </div>
            </div>
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y" style="border-color: var(--glass-border);">
                            ...
                            <tr class="hover:bg-white/5 transition-colors">
                                ...
                                <td class="p-4 text-sm font-mono font-bold" style="color: var(--color-text);">${{ number_format($payment->final_amount, 2) }}</td>
                                <td class="p-4">
