                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($testimonial->user_id)
                                        <div class="text-xs font-bold text-amber-500 mt-1">{{ __('مرسل من حساب طالب') }}</div>
                                    @endif
                                </td>
                                ...
                                <td>
                                    ...
                                    @elseif($testimonial->user_id)
                                        <span class="inline-flex items-center px-2 py-0.5 rounded-lg bg-amber-500/10 text-amber-500 text-xs font-bold">{{ __('قيد المراجعة') }}</span>
                                    @else
                                ...
                                <td>
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <form action="{{ route('admin.testimonials.destroy', $testimonial) }}" method="POST" class="inline" onsubmit="return confirm(__('هل أنت متأكد من الحذف؟'))">
                                            @csrf
                                            @method('DELETE')
