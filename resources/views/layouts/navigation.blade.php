...
@auth
    @if(auth()->user()->is_student)
        <a href="https://wa.me/966537191862" target="_blank"
           class="flex fixed bottom-[105px] right-6 sm:bottom-[115px] lg:bottom-8 lg:right-8 z-[105] w-14 h-14 rounded-full bg-[#25D366] text-white items-center justify-center shadow-2xl hover:scale-110 hover:shadow-[#25D366]/50 transition-all duration-300 group"
